...
export const homeHero =
  "relative isolate min-h-[calc(100dvh-var(--header-height))] overflow-hidden bg-white";

export const homeHeroGrid =
  "relative grid min-h-[calc(100dvh-var(--header-height))] items-center gap-10 py-10 lg:grid-cols-[minmax(0,32rem)_minmax(0,1fr)] lg:gap-8 lg:py-12";

export const homeHeroCopy =
  "relative z-10 flex max-w-[32rem] flex-col items-start gap-6 lg:gap-[38px]";
...
export const homeHeroActions =
  "flex flex-wrap gap-4 animate-hero-rise [animation-delay:180ms]";

export const homeHeroVisual =
  "relative z-0 min-h-[16rem] w-full lg:min-h-[28rem] lg:justify-self-end";

export const homeHeroMap =
  "pointer-events-none absolute inset-y-0 right-0 w-[min(100%,40rem)] max-w-none select-none object-contain object-right lg:w-[min(110%,46rem)]";

export const homeHeroTracker =
  "relative z-10 ml-auto mt-[min(42%,8rem)] w-full max-w-[29.5rem] rounded-3xl border border-black/20 bg-white p-6 lg:absolute lg:bottom-8 lg:right-0 lg:mt-0";

export const homeHeroTrackerTitle =
  "m-0 mb-4 font-display text-2xl font-semibold uppercase leading-normal text-black";
