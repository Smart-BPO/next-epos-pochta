    ...
    locales: {
      ...
      ru: {
        ...
        body: [
          ...
          "На сайте нет открытого тарифного прайса и авторасчёта. Менеджер готовит индивидуальный расчёт по направлению, весу, габаритам, способу доставки и объёму. Оставьте параметры в форме «Запросить стоимость» — мы свяжемся с вами.",
          "## Что сделать дальше",
          "На главной можно проверить географию, открыть каталог услуг или оставить бизнес-заявку. По вопросам обращайтесь в поддержку по телефону или в Telegram.",
        ],
      },
    },
  },
